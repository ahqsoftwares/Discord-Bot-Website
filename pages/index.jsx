...
export default function Index() {
  ...
  return (
    <>
      ...
      <img width="500" src="/img/bck.png" />
       ...
       How about moderating your own server with Asura bot? Create your own free world and create your own playlist, experience this pleasure with the best sounds. 
	  </p>
        <div className="animateHeader mt-10 flex flex-wrap items-center justify-center gap-x-4">
  
            <Link href={"https://discord.com/api/oauth2/authorize?client_id=1009060776784437289&permissions=8&scope=bot%20applications.commands"}>
              <a
                className={
  ...
  <Link href={"https://discordbotlist.com/bots/asura"}>
...
Vote Asura</a>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-y-12 lg:gap-y-0 lg:gap-x-12 py-24">
          <div className="col-span-4">
            <p className="text-white text-4xl font-bold" dangerouslySetInnerHTML={{ __html:"Asura Bot" }} />
            ...
            <a href="https://discord.com/api/oauth2/authorize?client_id=1009060776784437289&permissions=8&scope=bot%20applications.commands" className={"mt-10 flex items-center px-4 justify-center gap-x-2 shadow-lg shadow-amber-600/20 cursor-pointer rounded-xl py-4 font-medium bg-gradient-to-r from-amber-700 to-amber-500 hover:opacity-80 transition duration-200 text-white"}>
          ...
          <div className="col-span-8 grid grid-cols-1 lg:grid-cols-2 gap-6">
              ...
              <div>
                <div className="text-white">
                  ...
                  <p className="text-gray-500 line-clamp-4">With fast and customizable settings specific to your server, Asura gives you a musical pleasure to the fullest.</p>
                </div>
              </div>
              <div>
                <div className="text-white">
